...
df_aggregate_data['Оценка за интервал 20%'] = (
    0.4 * 0.05 * df_aggregate_data['Лекции1'] +
    0.4 * 0.05 * df_aggregate_data['Семинары1'] +
    0.4 * 0.2  * df_aggregate_data['Лабы1']
)
...
output_file = '../../data/7_Агрегированные_данные_проценты_с20%.xlsx'
