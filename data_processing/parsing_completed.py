...
df_aggregate_data = get_aggreagate_data_from_logs('../../data/raw/8_Логи.xlsx')

df_weights = pd.read_excel('../../data/8_weights.xlsx')

# Чтение данных из файла с оценками
file_path_grades = '../../data/raw/8_Оценки.xlsx'
...
output_file = '../../data/8_Агрегированные_данные_проценты.xlsx'
